angular.module('mainApp').factory('mainAppFactory', [
  'ISY.MapAPI.Map',
  '$location',
  'ISY.Repository',
  '$translate',
  ...
  function (map, $location, repository, $translate, translations) {
    ...
    var config = {
        ...
        configurl: 'https://arkiv.norgeskart.no/config'
      };
    var listprojects = [
        {
    ...
    function getProjectCallback(project, isOffline) {
      ...
      if (project.config.project.isyauth !== undefined) {
        ...
        mapConfig.authHost += '/authjson/';  // TODO: Remove hardcoded "geoinnsyn" instance.
      ...
      if (project.config.project.isypicklist !== undefined) {
        ...
        mapConfig.picklistHost += '/picklist/';  // mapFeaturesService.init(mapConfig.picklistHost);
      }
      ...
      mapConfig.mouseProjectionPrefix = 'EU89 UTM';
      //project.config.project.displayprojectionprefix;
      ...
      // if (layout) {
      mapConfig.showMousePosition = 'true';
      //layout.enablemousepositionctrl === 'true';
      // }
    ...
    var createGroup = function (groupId, groupNameLng1, groupNameLng2, visibleOnLoad) {
      ...
      mapConfig.languages.en[newGroup.groupId] = groupNameLng1;
      // has to be fix with correct value!
