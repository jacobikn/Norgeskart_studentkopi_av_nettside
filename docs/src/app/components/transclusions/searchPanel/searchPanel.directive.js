angular.module('searchPanel').directive('searchPanel', [
  '$timeout',
  'mainAppService',
  'ISY.MapAPI.Map',
  'ISY.EventHandler',
    ...
    return {
      ...
      link: function (scope) {
        ...
        var _coordinate = function (value, min, sec) {
          ...
          if (typeof min !== 'undefined') {
            coordinate = {
              ...
              min: parseFloat(min),
              sec: parseFloat(sec),
              value: parseInt(value) + parseFloat(min) / 60 + parseFloat(sec) / 3600
            };
          } else {
        ...
        var _parseInput = function (input) {
          ...
          var nondigitsRegEx = /[nN]|[eEøØoO]+/g;
          //   /\D+/g;
        ...
        var _addSearchOptionToPanel = function (name, data) {
          ...
          case 'stedsnavnPunkt':
            ...
            scope.searchOptionsDict['ssrFakta'] = _constructSearchOption('ssrFakta', 'fa fa-flag', true, '', { stedsnavn: stedsnavn });
        ...
        var _fetchStedsnavnPunkt = function () {
          ...
          var lon = scope.activePosition.lon;
          var epsgNumber = scope.mapEpsg.split(':')[1];
          var stedsnavnPunktUrl = mainAppService.generatStedsnavnPunktsok(lat, lon, epsgNumber);
        ...
        var _addKoordTransToSearchOptions = function () {
          var name = 'koordTrans';
          scope.searchOptionsDict[name] = _constructSearchOption(name, 'fa fa-map-marker-alt', true, 'Se koordinater', {});
        };
        ...
        var _addEmergencyPosterToSearchOptions = function () {
          ...
          scope.searchOptionsDict[name] = _constructSearchOption(name, 'fa fa-ambulance', true, 'Lage n\xf8dplakat', {});
        };
        ...
        var _checkQueryForCoordinates = function (query) {
          ...
          if (epsg) {
            ...
            if (sosi) {
              ...
              $http.get(koordTransUrl).then(function (response) {
                if (Object.prototype.hasOwnProperty.call(response.data, 'kode') && response.data.kode !== 0) {
                  ...
                  scope.showQueryPoint(scope.contructQueryPoint(response.data.y, response.data.x, 'EPSG:4326', 'coordGeo', ''));
                  return true;
                }
              });
            } else {
            ...
            if (params.east.value > 32.88 && params.north.value > -16.1 && params.east.value < 84.17 && params.north.value < 39.65) {
              ...
              return true;
            } else if (params.east.value > -2465220.6 && params.north.value > 4102904.86 && params.east.value < 771164.64 && params.north.value < 9406031.63) {
              epsg = 'EPSG:25833';
              ...
              scope.searchBarModel += '@' + scope.mapEpsg.split(':')[1];
              return true;
            } else if (params.north.value > -2465220.6 && params.east.value > 4102904.86 && params.north.value < 771164.64 && params.east.value < 9406031.63) {
              epsg = 'EPSG:25833';
        ...
        var _convertSearchResult2Json = function (document, source) {
          ...
          case 'ssr':
            ...
            if (Array.isArray(document.navn)) {
              stedsnavn = document.navn.map(function (a) {
                a.name = a.skrivemåte;
                if (a.kommuner) {
                  var kommuner = [];
                  ...
                  a.kommune = kommuner.reduce(function (res, k, i) {
                    return [
                      res,
                      k
                    ].join(i === kommuner.length - 1 ? ' og ' : ', ');
                  });
                } else {
                  a.kommune = '';
                }
          ...
          case 'adresse':
            ...
            if (parsedInput.gnr) {
              ...
              if (Array.isArray(document.adresser)) {
                adresser = document.adresser.filter(function (a) {
        ...
        var _downloadSearchBarFromUrl = function (_serviceDict, timestamp) {
          _queryDict[_serviceDict.source] = $.ajax({
            ...
            success: function (document) {
              if ((document.length && document.length > 0 || document.childNodes && document.childNodes[0].childNodes.length || document.adresser !== undefined || document.navn !== undefined) && scope.searchTimestamp == timestamp) {
        ...
        var _getValuesFromJson = function (identifiersDict, jsonObject) {
          ...
          if (jsonObject['navnestatus'] && jsonObject['navnestatus'] === 'historisk' || jsonObject['skrivem\xe5testatus'] && jsonObject['skrivem\xe5testatus'] === 'historisk og prioritert') {
        ...
        scope.resetSearchPanel = function () {
          scope.showSearchOptionsPanel();
          scope.searchPanelLayout = '';  // searchPanelFactory.setShowEiendomMarkering(false);
        };
          ...
          if (scope.searchOptionsDict['seEiendom'].name === 'seEiendom') {
            ...
            if (!searchPanelFactory.getShowEiendomMarkering()) {
              ...
              addLayerUrlTool.additionalOptions.style = new ol.style.Style({
                fill: new ol.style.Fill({ color: 'rgba(255,255,102,0.6)' }),
