angular.module('searchPanel').factory('searchPanelFactory', [
  'mainAppService',
  function (mainAppService) {
    var placenameHitsPerPage = 15;
    var placenamePage = 1;
    var mapEpsg = 'EPSG:25833';
    var availableUTMZones = [
        '25832',
        '25833',
        '25834',
        '25835',
    ...
    var sourceDict = {
        ...
        matrikkelnummer: 'G\xe5rds og bruksnummer'
      };
    var parseInput = function (input) {
      ...
      if (gbrnr.test(input)) {
        ...
        // snr confuses search engine not to output coordinates
        parsedQuery = parsedInput.municipality + '-' + parsedInput.numbers.join('/');
