angular.module('searchLagTurkartPanel').directive('searchLagTurkartPanel', [
  'toolsFactory',
  'ISY.EventHandler',
  '$http',
  'mainAppService',
    ...
    return {
      ...
      link: function (scope) {
        ...
        scope.orderMap = function () {
          ...
          $http.post(urlLagTurkart, json, { headers: { 'Content-Type': 'application/json' } }).then(function (response) {
