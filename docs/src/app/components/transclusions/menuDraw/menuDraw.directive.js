angular.module('menuDraw').directive('menuDraw', [
  'toolsFactory',
  'ISY.EventHandler',
  '$location',
  'mainAppService',
      ...
      link: function (scope) {
        ...
        scope.refreshStyle = function () {
          var style = new ol.style.Style({
              fill: new ol.style.Fill({ color: hex2rgba(_colorDict.Polygon, (100 - scope.fillAlpha) / 100) }),
              ...
              image: new ol.style.RegularShape({
                fill: new ol.style.Fill({ color: _colorDict.Point }),
              ...
              text: new ol.style.Text({
                ...
                text: scope.text,
                fill: new ol.style.Fill({ color: _colorDict.Text })
              })
            });
        ...
        var getDrawing = function (GeoJSON) {
          scope.setGeoJSON(GeoJSON);  // console.log(GeoJSON);
        };
        ...
        scope.saveButtonClick = function () {
          ...
          //TODO: This is a hack. CORS pre-flight should be implemented server-side
