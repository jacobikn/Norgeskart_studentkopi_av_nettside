angular.module('mainMenuGroupLayers').directive('mainMenuGroupLayers', [
  'ISY.MapAPI.Map',
  'ISY.MapAPI.Groups',
      ...
      link: function (scope) {
        ...
        scope.hasVisibleNRLLayers = function () {
          ...
          for (var i = 0; i < overlayLayers.length; i++) {
            ...
            if (layer.isVisible) {
              ...
              var isNRLLayer = lowerName.indexOf('luftfart') > -1 || lowerName.indexOf('hinder') > -1 || lowerName.indexOf('obstacle') > -1 || lowerName.indexOf('nrl') > -1;
        ...
        var _checkAndShowNRLWarning = function (isyLayer) {
          ...
          if (isyLayer.name) {
            ...
            isNRLLayer = lowerName.indexOf('luftfart') > -1 || lowerName.indexOf('hinder') > -1 || lowerName.indexOf('obstacle') > -1 || lowerName.indexOf('nrl') > -1;
          }
          ...
          if (!group.isAllLayersSelected) {
            ...
            if (group.isyLayers !== undefined) {
              ...
              for (var i = 0; i < sortedLayers.length; i++) {
                ...
                if (i === 0) {
                  // Only show warning once per group
        ...
        _resetGroups();
        _initGroups();  // console.log(scope.groupLayers);
      }
    };
  }
]);