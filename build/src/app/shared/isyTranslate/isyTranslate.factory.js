angular.module('isyTranslate').factory('customLoader', [
  ...
  var translateOptions = {
      ...
      nn: {
        east: '&Oslash; ',
        north: 'N ',
        start_modify: 'Vel objekt og start redigering.',
        add_layer_start_drawing: 'Klikk for \xe5 starte teikning',
        add_layer_continue_drawing: 'Klikk for \xe5 fortsetje \xe5 teikne.',
        add_layer_modify_object: 'Vel objekt og start redigering.',
        start_drawing: 'Klikk for \xe5 starte teikning',
        continue_drawing: 'Klikk for \xe5 fortsetje \xe5 teikne polygon. Klikk i siste punktet for \xe5 avslutte polygon.',
        start_measure: 'Klikk for \xe5 starte teikning',
        continue_measure: 'Klikk for \xe5 fortsetje \xe5 teikne polygon. Klikk i siste punktet for \xe5 avslutte polygon.',
        start_measure_line: 'Klikk for \xe5 starte teikning',
        continue_measure_line: 'Klikk for \xe5 fortsetje \xe5 teikne linja. Klikk i siste punktet for \xe5 avslutte linja.'
      },
      en: {
        east: 'E ',
        north: 'N ',
        start_modify: 'Select object and start modifying.',
        add_layer_start_drawing: 'Click to start drawing',
        add_layer_continue_drawing: 'Click to continue drawing.',
        add_layer_modify_object: 'Select object and start modifying.',
