angular.module('tools').factory('toolsElevationProfileFactory', [
  'mainAppService',
  '$http',
  '$q',
  function (mainAppService, $http, $q) {
    ...
    var _uploadGpxFile = function (gpx) {
      ...
      $http.post(mainAppService.uploadGpxFileService(), gpx).then(function (gpxUrlResult) {
    ...
    var _generateElevationChart = function (deferred) {
      $http.get(mainAppService.generateElevationChartServiceUrl(gpxUrl)).then(function (result) {
