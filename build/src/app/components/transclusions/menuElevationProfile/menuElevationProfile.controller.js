angular.module('menuElevationProfile').controller('menuElevationProfileController', [
  '$scope',
  'toolsElevationProfileFactory',
  ...
  function (scope, toolsElevationProfileFactory, menuElevationProfileFactory) {
    ...
    scope.calculateElevationProfile = function () {
      if (scope.gpx) {
        ...
        toolsElevationProfileFactory.generateElevationProfile(scope.gpx).then(function () {
      ...
      menuElevationProfileFactory.setElevationBtnActivity(false);  // scope.elevationProfileActive = false;
    };
